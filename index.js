...
client.on('guildMemberAdd', (member) => {
    ...
    member.send('Bienvenue sur ElderiaCraft ! n\'hésite pas à aller dans le salon règlement afin d\'en prendre connaissance.');
});

client.on('guildMemberRemove', (member) => {
    let leaveChannel = client.channels.cache.get('834532273960255559');
